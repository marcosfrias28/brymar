          ...
          <div className="flex-1 p-4 flex flex-col justify-between">
            <div className="flex justify-between items-start gap-4">
              <div className="flex-1 min-w-0">
                <h3 className="font-semibold text-arsenic text-sm line-clamp-2 mb-1">{post.title}</h3>

                <p className="text-xs text-blackCoral/70 line-clamp-2 mb-2">{post.excerpt}</p>

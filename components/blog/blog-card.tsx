    ...
    <Card className="border-blackCoral shadow-lg hover:shadow-xl hover:border-secondary/20 transition-all duration-300 group">
      ...
      <div className="relative h-48 overflow-hidden rounded-t-lg">
        ...
        <div className="absolute top-3 left-3 flex gap-2">
          ...
          <Badge className="bg-arsenic text-white">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                size="sm"
                className="bg-white/80 hover:bg-white text-arsenic"
              >
      ...
      <CardContent className="p-4">
        {/* Title */}
        <h3 className="font-semibold text-arsenic text-lg mb-2 line-clamp-2 leading-tight">
          {post.title}
        </h3>

        {/* Excerpt */}
        <p className="text-blackCoral/70 text-sm mb-3 line-clamp-3">
          {post.excerpt}
        </p>

        {/* Meta Information */}
        <div className="space-y-2 text-sm text-blackCoral">

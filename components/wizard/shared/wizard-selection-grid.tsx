...
export function WizardSelectionGrid({
  ...
  const variantStyles = {
    default: "p-4 rounded-lg border bg-card hover:bg-accent/50 transition-colors",
    compact: "p-3 rounded-md border bg-muted/30 hover:bg-muted/50 transition-colors",

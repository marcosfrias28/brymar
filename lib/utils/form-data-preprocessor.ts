 ...
 */
export function preprocessObjectData(data: Record<string, any>): Record<string, any> {
    const processed: Record<string, any> = {};
 ...
 */
export function parseCoordinates(coordinatesStr: string): { latitude: number; longitude: number } | null {
    try {
 ...
 */
export function safeBooleanConversion(value: any, fallback: boolean = false): boolean {

...
export const gridUtils = {
    ...
    getAutoFitClasses: (minWidth = "280px"): string => {
...
export const responsiveUtils = {
    ...
    getResponsiveTextSize: (level: "xs" | "sm" | "base" | "lg" | "xl" = "base"): string => {
        switch (level) {
            case "xs":
...
export const secondaryColorUtils = {
    ...
    getSecondaryAccent: (intensity: "light" | "medium" | "strong" = "medium"): string => {
        switch (intensity) {
            case "light":
    ...
    getSecondaryStatus: (status: "active" | "pending" | "inactive" = "active"): string => {
        switch (status) {
            case "pending":
...
export function createAccentedGrid(
    ...
    const accentClasses = showAccents ? secondaryColorUtils.getSecondaryAccent() : ""

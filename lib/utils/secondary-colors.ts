...
export const secondaryColorClasses = {
    ...
    accentHover: "hover:bg-secondary/20 hover:border-secondary/30 transition-colors duration-200",
    ...
    badgeWithBorder: "bg-secondary text-secondary-foreground border border-secondary/20 shadow-sm",

    // Status indicator utilities
    statusActive: "bg-secondary/20 text-secondary-foreground border-secondary/40",
    statusPending: "bg-secondary/10 text-secondary-foreground/80 border-secondary/20",

    // Interactive state utilities
    interactive: "hover:bg-secondary/10 active:bg-secondary/20 transition-colors duration-150",

    // Button variant utilities
    buttonSecondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80 focus-visible:ring-secondary/50",

    // Card hover effects
    cardHover: "hover:border-secondary/30 hover:shadow-lg hover:shadow-secondary/5 transition-all duration-200",

    // Navigation active states
    navActive: "bg-secondary/20 text-secondary-foreground border-l-2 border-secondary",
    ...
    selectFocus: "focus-visible:border-secondary focus-visible:ring-secondary/50 hover:border-secondary/30",
} as const;
...
export const statusVariants = {
    ...
    pending: "bg-secondary/10 text-secondary-foreground/80 border border-secondary/20",
    highlighted: "bg-secondary text-secondary-foreground border border-secondary/30",
} as const;

// Badge variants using secondary colors
export const badgeVariants = {
    secondary: "bg-secondary text-secondary-foreground",
    secondaryOutline: "border border-secondary text-secondary-foreground bg-secondary/10",
    secondarySubtle: "bg-secondary/20 text-secondary-foreground border border-secondary/30",
} as const;

// Navigation state classes
export const navigationClasses = {
    active: "bg-secondary/20 text-secondary-foreground border-l-2 border-secondary font-medium",
    hover: "hover:bg-secondary/10 transition-colors duration-200",
    subActive: "bg-secondary/30 text-secondary-foreground border-l-2 border-secondary ml-2 font-medium",
...
export const interactiveClasses = {
    ...
    input: "focus-visible:border-secondary focus-visible:ring-secondary/50 focus-visible:ring-[3px]",
    select: "focus-visible:border-secondary focus-visible:ring-secondary/50 hover:border-secondary/30",
    textarea: "focus-visible:border-secondary focus-visible:ring-secondary/50 focus-visible:ring-[3px]",
} as const;

// Utility function to combine secondary color classes
export const combineSecondaryClasses = (...classes: (keyof typeof secondaryColorClasses)[]) =>

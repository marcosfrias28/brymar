...
export const translations = {
  en: {
    ...
    dashboard: {
      ...
      propertiesAndLandsAdded: "Properties and Lands Added",
  ...
  es: {
    ...
    dashboard: {
      ...
      propertiesAndLandsAdded: "Propiedades y Terrenos Añadidos",
    ...
    landForm: {
      ...
      filter: "Filtrar",
      noResults: "No se encontraron terrenos",
      view: "Ver",
      edit: "Editar",
      delete: "Eliminar",
      location: "Ubicación"
  ...
  it: {
    ...
    dashboard: {
      ...
      propertiesAndLandsAdded: "Proprietà e Terreni Aggiunti",
    ...
    landForm: {
      ...
      search: "Cerca terreni...",
      filter: "Filtra",
      noResults: "Nessun terreno trovato",
      view: "Visualizza",
      edit: "Modifica",
      delete: "Elimina",
      location: "Posizione"

...
import { invalidateQueries, InvalidationAction, InvalidationContext } from '@/lib/query/invalidation';
...
export interface BaseMutationOptions<TData, TError, TVariables, TContext>
    ...
    invalidationContext?: (variables: TVariables, data?: TData) => InvalidationContext;
 ...
 */
export interface BaseMutationResult<TData, TError, TVariables, TContext> {
 ...
 */
export function useBaseMutation<TData = unknown, TError = Error, TVariables = void, TContext = unknown>(
    ...
    const mutation = useMutation({
        ...
        onMutate: async (variables: TVariables) => {
            ...
            // Show loading toast
            if (showLoadingToast) {
                const message = loadingMessage || 'Procesando...';
 ...
 */
export function useCreateMutation<TData = unknown, TError = Error, TVariables = void, TContext = unknown>(
    mutationFn: (variables: TVariables) => Promise<TData>,
    options: BaseMutationOptions<TData, TError, TVariables, TContext> = {}
): BaseMutationResult<TData, TError, TVariables, TContext> {
 ...
 */
export function useUpdateMutation<TData = unknown, TError = Error, TVariables = void, TContext = unknown>(
    mutationFn: (variables: TVariables) => Promise<TData>,
    options: BaseMutationOptions<TData, TError, TVariables, TContext> = {}
): BaseMutationResult<TData, TError, TVariables, TContext> {
    return useBaseMutation(mutationFn, {
 ...
 */
export function useDeleteMutation<TData = unknown, TError = Error, TVariables = void, TContext = unknown>(
    mutationFn: (variables: TVariables) => Promise<TData>,
    options: BaseMutationOptions<TData, TError, TVariables, TContext> = {}
): BaseMutationResult<TData, TError, TVariables, TContext> {
    return useBaseMutation(mutationFn, {

...
const coordinates = [
    ...
    { id: 2, name: 'Santo Domingo Norte', lat: 18.5204, lng: -69.9540 },
    ...
    { id: 8, name: 'Bonao', lat: 18.8070, lng: -70.2204 },
    { id: 9, name: 'Barahona', lat: 18.0731, lng: -71.2288 },
    { id: 10, name: 'Nagua', lat: 19.2177, lng: -69.4203 },
];

coordinates.forEach(coord => {
    console.log(`UPDATE lands SET location = jsonb_set(COALESCE(location::jsonb, '{}'), '{coordinates}', '{"latitude": ${coord.lat}, "longitude": ${coord.lng}}') WHERE id = ${coord.id};`);
});

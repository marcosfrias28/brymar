...
const sampleCoordinates = [
    ...
    { lat: 18.5204, lng: -69.9540 }, // Santo Domingo Norte
...
async function addCoordinatesToLands() {
    try {
        ...
        for (let i = 0; i < allLands.length; i++) {
            ...
            console.log(`Actualizado terreno ${land.id} con coordenadas ${coordinates.lat}, ${coordinates.lng}`);
        }

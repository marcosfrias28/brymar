...
const sampleProperties = [
	...
	},
	{
		...
		images: ["/images/properties/roma-centro-1.jpg"],
		contactInfo: {
	...
	},
	{
		...
		images: ["/images/properties/toscana-casa-1.jpg"],
		contactInfo: {
	...
	},
	{
		...
		images: ["/images/properties/villa-como-1.jpg"],
		contactInfo: {
...
const sampleLands = [
	...
	},
	{
		...
		images: ["/images/lands/trentino-bosco-1.jpg"],
		contactInfo: {
...
async function createTablesIfNotExist() {
	...
	try {
		...
		`;
		console.log("✅ Lands table created/verified");
		...
		try {
			await sql`
				INSERT INTO properties (
					...
					${JSON.stringify(property.contactInfo)}
				)
			`;
		...
		try {
			await sql`
				INSERT INTO lands (
					...
					${JSON.stringify(land.contactInfo)}
				)
			`;

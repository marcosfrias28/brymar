...
export const PAGE_SECTIONS = {
    home: {
        hero: {
            ...
            description: 'Descubre una amplia selección de propiedades exclusivas, desde apartamentos modernos hasta casas de lujo.',
            content: {
                ...
                faqs: [
                    {
                        ...
                        answer: "Absolutamente. En Marbry Inmobiliaria trabajamos contigo para encontrar propiedades que se adapten perfectamente a tus necesidades específicas, desde apartamentos de lujo hasta villas espaciosas, todo personalizado según tus preferencias y presupuesto."
                    },
                    {
                        id: "faq-2",
                        question: "¿Dónde puedo encontrar propiedades con Marbry?",
                        answer: "Operamos en las mejores ubicaciones de Florida, incluyendo Miami, Orlando, Tampa y áreas circundantes. Nuestro portafolio incluye propiedades residenciales, comerciales y de inversión en las zonas más exclusivas y prometedoras del estado."
                    },
                    {
                        id: "faq-3",
                        question: "¿Cuáles son los pasos para comprar con Marbry?",
                        answer: "Nuestro proceso es simple: 1) Consulta inicial gratuita para entender tus necesidades, 2) Búsqueda personalizada de propiedades, 3) Visitas guiadas a propiedades seleccionadas, 4) Negociación y asesoría legal, 5) Cierre exitoso con soporte completo."
                    },
                    {
                        id: "faq-4",
                        question: "¿Qué hace diferente a Marbry Inmobiliaria?",
                        answer: "Nuestra combinación única de experiencia local, tecnología avanzada, servicio personalizado y red de contactos exclusiva. Cada cliente recibe atención VIP con acceso a propiedades off-market y asesoría experta durante todo el proceso."
                    }
                ]
            }
        },
        features: {
            ...
            description: 'Más de 10 años ayudando a familias a encontrar su hogar perfecto.',
            content: {
                features: [
                    {
                        icon: 'home',
                        title: 'Propiedades Verificadas',
                        description: 'Todas nuestras propiedades pasan por un riguroso proceso de verificación.'
                    },
                    {
                        icon: 'users',
                        title: 'Asesoría Personalizada',
                        description: 'Nuestro equipo de expertos te acompaña en todo el proceso.'
                    },
                    {
                        icon: 'shield-check',
                        title: 'Transacciones Seguras',
                        description: 'Garantizamos la seguridad y transparencia en cada transacción.'
                    },
                    {
                        icon: 'clock',
                        title: 'Disponibilidad 24/7',
                        description: 'Estamos disponibles cuando nos necesites, cualquier día de la semana.'
                    }
                ]
            }
        },
                ...
                testimonials: [
                    {
                        name: 'María González',
                        role: 'Propietaria',
                        content: 'Excelente servicio, encontramos nuestra casa ideal en tiempo récord.',
                        rating: 5,
                    ...
                    },
                    {
                        ...
                        role: 'Inversionista',
                        content: 'Profesionales confiables que me ayudaron a hacer una excelente inversión.',
                        rating: 5,
                    ...
                    },
                    {
                        ...
                        content: 'Me guiaron paso a paso en mi primera compra. Muy recomendados.',
                        rating: 5,
    ...
    about: {
        mission: {
            ...
            description: 'Conectar a las personas con sus hogares ideales a través de un servicio excepcional y tecnología innovadora.',
            content: {
                values: [
...
export function getContactInfoValue(type: ContactInfo['type'], fallback: string = ''): string {
    const info = CONTACT_INFO.find(item => item.type === type);
    return info?.value || fallback;
}

export function getPageSection(page: string, section: string): PageSection | null {

...
describe('Authentication Server Actions', () => {
    ...
    describe('changePassword', () => {
        ...
        it('should validate new password confirmation', async () => {
            ...
            expect(result.success).toBe(false);
            expect(result.errors?.confirmPassword).toContain('New passwords do not match');
        });
        ...
        it('should prevent using same password', async () => {
            ...
            expect(result.success).toBe(false);
            expect(result.errors?.newPassword).toContain('New password must be different from current password');
        });
    });

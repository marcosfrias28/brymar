...
import { PropertyFormData, PropertyBasicInfo, PropertyType, PropertyCharacteristic } from '@/types/wizard';
...
export const ServerPropertyValidationSchema = z.object({
    ...
    title: z.string()
        ...
        .regex(/^[a-zA-ZáéíóúÁÉÍÓÚñÑ0-9\s\-.,()]+$/, 'El título contiene caracteres no permitidos'),
...
function isValidDominicanProvince(province: string): boolean {
    ...
    return dominicanProvinces.some(validProvince =>

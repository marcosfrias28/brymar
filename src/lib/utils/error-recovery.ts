...
import { WizardError, AIServiceError, UploadError, ValidationError, MapServiceError, DraftServiceError, NetworkError } from '../errors/wizard-errors';
...
export function handleErrorWithRecovery(
    ...
    const wizardError = error instanceof WizardError
        ? error
        : WizardError.prototype.constructor.call(Object.create(WizardError.prototype),

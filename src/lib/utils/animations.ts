...
export const hoverAnimations = {
	...
	gentle:
		"hover:bg-secondary/10 hover:border-secondary/20 transition-all duration-200 ease-out",
	prominent:
		"hover:bg-secondary/15 hover:border-secondary/30 hover:shadow-md transition-all duration-200 ease-out",
	...
	// Combined effects
	liftAndGlow:
		"hover:bg-secondary/10 hover:shadow-lg hover:shadow-secondary/10 hover:-translate-y-0.5 transition-all duration-200 ease-out",
	borderGlow:
		"hover:border-secondary/40 hover:shadow-[0_0_0_1px_rgb(var(--secondary)/0.2)] transition-all duration-200 ease-out",
} as const;
...
export const focusAnimations = {
	...
	ringLarge:
		"focus-visible:ring-4 focus-visible:ring-secondary/40 focus-visible:ring-offset-2 transition-all duration-150 ease-out",
	border:
		"focus-visible:border-secondary focus-visible:shadow-[0_0_0_1px_rgb(var(--secondary)/0.5)] transition-all duration-150 ease-out",
...
export const loadingAnimations = {
	pulse: "animate-pulse",
	shimmer:
		"animate-pulse bg-gradient-to-r from-muted via-secondary/20 to-muted",
	spin: "animate-spin",
...
export const sidebarAnimations = {
	...
	expandMenu:
		"transition-all duration-300 ease-out data-[state=open]:animate-accordion-down data-[state=closed]:animate-accordion-up",

	// Chevron rotation
	chevronRotate:
		"transition-transform duration-200 ease-out group-data-[state=open]:rotate-90",
	...
	activeSlide:
		"relative before:absolute before:left-0 before:top-0 before:h-full before:w-1 before:bg-secondary before:transition-all before:duration-200",
} as const;
...
export const formAnimations = {
	...
	inputError:
		"focus-visible:ring-red-500/50 border-red-500 transition-all duration-200 ease-out",

	// Label animations
	floatingLabel:
		"transition-all duration-200 ease-out peer-focus:text-secondary peer-focus:scale-90 peer-focus:-translate-y-2",

	// Validation states
	valid:
		"border-green-500 focus-visible:ring-green-500/50 transition-all duration-200 ease-out",
	invalid:
		"border-red-500 focus-visible:ring-red-500/50 transition-all duration-200 ease-out",
} as const;

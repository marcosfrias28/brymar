import { Coordinates, Address, MapService } from '@/types/wizard';
import { MapServiceError, NetworkError } from "../errors/wizard-errors";
import { retryNetworkRequest } from "../utils/retry-logic";
...
class MapServiceImpl implements MapService {
    ...
    addMarker(coordinates: Coordinates): any {
        // This will be handled by the React component
        return null;
    }
        ...
        try {
            ...
            if (
                ...
                throw new MapServiceError(
                    ...
                    false,
                    { coordinates: { latitude, longitude }, bounds: DOMINICAN_REPUBLIC_BOUNDS }
                );
            }
            ...
            const street = streetParts.length > 0
                ? streetParts.join(" ")
                : addressComponents.neighbourhood || addressComponents.suburb || "Dirección no disponible";
            ...
            const address: Address = {
                ...
                formattedAddress: data.display_name || `${street}, ${city}, ${province}`,
            };

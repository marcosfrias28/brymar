			...
			<div className="container">
				...
				<div className="content">
					...
					<div className="message">
						Gracias por registrarte en {companyName}. Para completar tu registro
						y activar tu cuenta, necesitamos verificar tu dirección de correo
						electrónico.
					</div>
					...
					<div className="verification-section">
						<a className="cta-button" href={verificationUrl}>
							Verificar Email
						</a>
					</div>

		...
		<div className="space-y-16">
			...
			<section className="space-y-6 text-center">
				<h2 className="font-bold text-4xl text-foreground">
					Tu Socio Confiable en Bienes Raíces
				</h2>
				<p className="mx-auto max-w-3xl text-lg text-muted-foreground">
					En Marbry, nos apasiona ayudar a las personas a encontrar no solo una
					casa, sino un hogar. Con más de 15 años de experiencia en el mercado
					inmobiliario, hemos construido una reputación basada en la confianza,
					la profesionalidad y resultados excepcionales.
				</p>
			</section>

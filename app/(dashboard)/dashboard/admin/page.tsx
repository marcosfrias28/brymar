...
export default function AdminPage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case "online":
        return <Badge variant="default" className="bg-green-100 text-green-800">En línea</Badge>;
      case "warning":
          ...
          <CardContent>
            <div className="grid gap-4 md:grid-cols-3">
              <div className="text-center p-4 border rounded-lg">
                ...
                <p className="text-sm text-muted-foreground">Certificado válido hasta 2025</p>
              </div>
              <div className="text-center p-4 border rounded-lg">
                <KeyIcon className="h-8 w-8 mx-auto mb-2 text-blue-600" />
                <h3 className="font-medium">API Keys</h3>
                <p className="text-sm text-muted-foreground">5 claves activas</p>
              </div>
              <div className="text-center p-4 border rounded-lg">
                <UsersIcon className="h-8 w-8 mx-auto mb-2 text-purple-600" />
                <h3 className="font-medium">Roles</h3>
                <p className="text-sm text-muted-foreground">3 roles configurados</p>
              </div>
            </div>
          </CardContent>
        </Card>
